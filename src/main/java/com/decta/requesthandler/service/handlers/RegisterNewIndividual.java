...
@Component
public class RegisterNewIndividual implements DocumentHandler {

    private final RequestType REQUEST_TYPE = RequestType.REGISTER_NEW_INDIVIDUAL;
    private PersonalDataBase personalDataBase;

    @Autowired
    public RegisterNewIndividual(PersonalDataBase personalDataBase) {
